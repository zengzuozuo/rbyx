            ...
            <ul>
                <li v-for="(item,index) in pageData">
                    ...
                    <div class="btn-wrap clearfix">
                        <a href="javascript:;" v-if="item[0].status == 1 || item[0].status == 2" @click="$router.push('shenqintuikuan?t=1&oid=' + item[0].ordersn)">仅退款</a>
                        <a href="javascript:;" v-if="item[0].status == 2 || item[0].status == 3" @click="$router.push('shenqintuikuan?t=2&oid=' + item[0].ordersn)">退货退款</a>
                        <a href="javascript:;" v-if="item[0].status == 5 || item[0].status == 9 || item[0].status == 90" @click="$router.push('aftersalesstatus?oid=' + item[0].ordersn)">查看退款状态</a>
                    </div>
                </li>
