<template>
    <div class="intwriteorder-page">
        ...
        <div class="main">
            ...
            <yd-cell-group>
                ...
                <yd-cell-item type="a" href="javascript:;">
                    ...
                    <span slot="right">-{{ goodsData.goodslist[0].integral }}</span>
                </yd-cell-item>
            </yd-cell-group>
            <ul class="goods-list">
        ...
        <footer>
            <div>应付：¥0.00 <s>{{ goodsData.goodslist[0].integral }}积分</s></div>
            <a href="javascript:;" @click="payment">兑换</a>
        </footer>
    </div>
</template>
