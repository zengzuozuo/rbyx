<template>
    <div class="recommend-component scroll-wrap" id="recommend-component" ref="recommendComponent">
...
export default {
    ...
    mounted() {
        ...
        this.$refs.recommendComponent.addEventListener("scroll", function() {
            that.recommendScrollTop = this.scrollTop;
        })
    },
    methods: {
        getData() {
    ...
    activated() {
        this.$refs.recommendComponent.scrollTop = this.recommendScrollTop;
