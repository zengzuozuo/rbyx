<template>
    <div class="timebuy-component" id="timebuy-component">
        <div class="sroll-wrap" style="position: relative;min-height: 100.1%;" ref="main">
...
export default {
    ...
    mounted() {
        ...
        this.myScroll = new iScroll("#timebuy-component",{
